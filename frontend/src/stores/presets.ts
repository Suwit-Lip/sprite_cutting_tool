...
const BUILTINS: Preset[] = [
  { id: '__icons', name: 'Icons แน่น', params: { bgThreshold: 248, minSize: 16, groupDilate: 2, padding: 4, keepShadow: true } },
  { id: '__items', name: 'Items ห่าง', params: { bgThreshold: 240, minSize: 32, groupDilate: 4, padding: 8, keepShadow: true } },
  { id: '__objects', name: 'Objects ใหญ่', params: { bgThreshold: 235, minSize: 80, groupDilate: 8, padding: 12, keepShadow: true } },
  { id: '__soft', name: 'พื้นหลังนวลๆ', params: { bgThreshold: 220, minSize: 24, groupDilate: 6, padding: 6, keepShadow: false } },
]
